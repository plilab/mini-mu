...
prettyConfig (CommandConfig env store command) = 
  pretty "<Command Config> " <> prettyEnv env <> prettyStore store <> prettyCommand command
prettyConfig (ValueConfig store value coValue) = 
  pretty "<Value Config> " <> prettyStore store <> prettyValue value <> prettyCoValue coValue
